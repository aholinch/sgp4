...
use super::elset_rec::ElsetRec as ElsetRec;
    ...
    pub fn dpper (e3:f64, ee2:f64, peo:f64, pgho:f64, pho:f64,
        pinco:f64, plo:f64, se2:f64, se3:f64, sgh2:f64,
        sgh3:f64, sgh4:f64, sh2:f64, sh3:f64, si2:f64,
        si3:f64, sl2:f64, sl3:f64, sl4:f64, t:f64,
        xgh2:f64, xgh3:f64, xgh4:f64, xh2:f64, xh3:f64,
        xi2:f64, xi3:f64, xl2:f64, xl3:f64, xl4:f64,
        zmol:f64, zmos:f64,
        init:char,
        rec: &mut ElsetRec,
        opsmode:char)
    ...
    pub fn dscom (epoch:f64, ep:f64, argpp:f64, tc:f64, inclp:f64, nodep:f64, np:f64,rec: &mut ElsetRec)
    {
        // -------------------------- constants ------------------------- */
        let zes:f64 = 0.01675;
        let zel:f64 = 0.05490;
    ...
    pub fn jday(year:i32, mon:i32, day:i32, hr:i32, minute:i32, sec:f64) -> (f64,f64)
    {
        ...
        jd = 367.0 * (year as f64) -
            ...
            (day as f64) + 1721013.5;  // use - 678987.0 to go to mjd directly
